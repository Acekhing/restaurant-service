...
echo ""
bold "Access points:"
echo "  Retailer Portal:  http://$SERVER_IP:${APP_PORT:-80}/"
echo "  Employee Portal:  http://$SERVER_IP:${APP_PORT:-80}/waiter/"
echo "  BackOffice / Admin: http://$SERVER_IP:${APP_PORT:-80}/backoffice/"
