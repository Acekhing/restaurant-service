...
public class Retailer : BaseEntity, ISoftDeletable
{
    [Required]
    ...
    public List<OrderTelephoneNumber> OrderTelephoneNumbers { get; set; } = new();
...
public class RetailerOpeningDayHour
{
...
public class DisplayTime
{
    ...
    [Required]
    public List<DisplayTimePeriod> Time { get; set; } = new();
}

public class DisplayTimePeriod
{
    public string? From { get; set; }
    public string? To { get; set; }
}

public class OrderTelephoneNumber
{
    public string? Id { get; set; }
    public string? ContactNumber { get; set; }
    public bool ShouldReceiveOrderNotification { get; set; }
